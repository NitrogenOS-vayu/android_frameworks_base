...
import android.provider.Sttings;
...
public class BatteryMeterView extends LinearLayout implements DarkReceiver {
    ...
    void updateShowPercent(int mBatteryStyle) {
     ...
     */
    void scaleBatteryMeterViews(int mBatteryStyle) {
        Resources res = getContext().getResources();
    ...
    public void updateBatteryStyle(boolean isUnknown, int mBatteryStyle) {
        switch (mBatteryStyle) {
            case BATTERY_STYLE_PORTRAIT:
                mBatteryIconView.setImageDrawable(isUnknown ? getUnknownStateDrawable(): mThemedDrawable);
                mBatteryIconView.setVisibility(View.VISIBLE);
                scaleBatteryMeterViews(mBatteryStyle);
                break;
